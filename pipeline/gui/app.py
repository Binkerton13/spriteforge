...
def create_app():
    ...
    def index():
        return jsonify({
            "service": "SpriteForge GUI Backend",
            ...
            "routes": [
                ...
                "/api/styles/<style_id>",
                "/api/prompts",
                "/api/prompts/<template_id>",
                "/api/workflows",
                "/api/workflows/<name>",
                "/api/workflows/validate",
                "/api/workflows/nodes/<workflow_name>",
                "/api/workflows/node/<workflow_name>/<node_id>",
                "/api/batch/create",
                "/api/batch/run/<batch_id>",
                "/api/batch/status/<batch_id>",
                "/api/project/save",
                "/api/project/load/<project_id>",
                "/api/project/list"
            ]
        })
    ...
    def sprites_generate():
        ...
        # Style preset overrides model selection where keys overlap
